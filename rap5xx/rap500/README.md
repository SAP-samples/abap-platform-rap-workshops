...
The *cube view* contains dimensional data (= descriptive data such as a carrier ID or an airline ID) as well as measurable data (=quantifiable fields that can be calculated, e.g. the number of flight bookings or the flight price). We refer to these as **dimension fields** and **measures**.
...
- Total flight price booked by an agency  
...
- [Exercise 1 - Create the analytical data model](exercises/ex1/README.md)  
    - [Generate the data model](exercises/ex1#Generate-the-data-model)
    - [Dimensions](exercises/ex1#dimensions)  
     ...
     - [Interface View](exercises/ex1#interface-view)
...
- [Exercise 4 - Test Live Data Connection](exercises/ex4/README.md)    
    - [Filter the story](exercises/ex4#exercises-41---filter-the-story)                                   
